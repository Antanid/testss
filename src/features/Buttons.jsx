...
// ==========================================================
const Spinner = () => <span className="loading-spinner"></span>
...
const BtnLang = ({ className }) => {
  ...
  const handleToggle = () => {
    ...
    const textElements = document.querySelectorAll(
      'p, h1, h2, h3, h4, h5, h6, span, li, button, a, label',
    )
