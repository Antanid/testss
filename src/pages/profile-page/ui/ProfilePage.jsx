  ...
  return (
    <div>
      <main className="page page_profile">
        <div className="bg-star-pattern bg-star-pattern_right">
          <Images.BgStars />
        </div>
        <div className="bg-star-pattern bg-star-pattern_right">
          <Images.BgStars />
        </div>
        <div className="bg-star-pattern bg-star-pattern_left">
          <Images.BgStars />
        </div>
        <section className="section">
          <h2 className="text text_h2">{language === 'en' ? 'Account' : 'Личный кабинет'}</h2>
