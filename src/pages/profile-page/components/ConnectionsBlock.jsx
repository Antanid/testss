...
export const ConnectionsBlock = ({ language }) => {
  ...
  const handleTGToggleEdit = () => {
    setIsTGLock(prev => !prev)
  }
  ...
  const handleEmailToggleEdit = () => {
    setIsEmailLock(prev => !prev)
  }
              ...
              <h2 className="text text_h3">
                <div className="connections__top__image-container">
                  {connect.id === 'tg' && (
                    ...
                    >
                      <path
                        d="M12.1493 15.2081L19.2326 8.66962M26.4784 4.67933L20.4994 22.6164C19.9636 24.2239 19.6955 25.0281 19.2333 25.2946C18.8325 25.5258 18.3362 25.5644 17.8996 25.3972C17.3962 25.2044 16.9876 24.4514 16.1726 22.9466L12.3856 15.9552C12.2562 15.7164 12.1915 15.5975 12.1051 15.494C12.0284 15.4022 11.9399 15.3195 11.8405 15.2487C11.7309 15.1708 11.6043 15.1124 11.3572 14.9983L3.76573 11.4945C2.13558 10.7421 1.32043 10.3656 1.11155 9.90091C0.930397 9.49791 0.97171 9.03935 1.22217 8.66933C1.51097 8.24266 2.38203 7.9948 4.124 7.50003L23.5556 1.98092C24.9251 1.59195 25.6101 1.39762 26.0727 1.55438C26.4756 1.69092 26.7932 1.98384 26.9412 2.35577C27.1109 2.78256 26.9002 3.41457 26.4793 4.67746L26.4784 4.67933Z"
                        strokeWidth="2"
                      />
                    </svg>
                  )}
