        ...
        <main className='page page__exchanger'>
          <section className='section exchanger__section'>
            ...
            <div className='exchanger'>
              <div className='bg-stars-pattern'><Images.BgStars/></div>
              <div className='bg-stars-pattern bg-stars-pattern__right'><Images.BgStars/></div>
              <div className='container_default exchanger__container'>
                
                {/* ~~~~~~~~~~~~~~~~~~| Разделы |~~~~~~~~~~~~~~~~~~~~~~ */}
                <div className='exchanger__chapters'>
                  <div className={`exchanger__chapter-background ${activeChapter === 0 ? 'exchanger__chapter-background__left' : 'exchanger__chapter-background__right'}`}></div>
                  <button className={`exchanger__chapter ${activeChapter === 0 ? 'exchanger__chapter_active' : ''}`} onClick={() => setActiveChapter(0)}>
                  ...
                  <button className={`exchanger__chapter ${activeChapter === 1 ? 'exchanger__chapter_active' : ''}`} onClick={() => setActiveChapter(1)}>
                    <h3 className='exchanger__chapter_h2 text text_h3'>
                      {language === 'en' ?
                        'Manual exchange' :
                        'Ручной обмен'}
                ...
                <div className='exchanger__content'>
                  <div className='bg-stars-pattern bg-stars-pattern__bottom'><Images.BgStars/></div>
                  {/* ~~~~~~~~~~~~~~~~~~| Автоматический обмен |~~~~~~~~~~~~~~~~~~~~~~ */}
                  {activeChapter === 0 && (
                    <AutoExchange
                      language={language}
          ...
          <div className='exchanger-info__item'>
            <h2 className='text text_h2'>
              <div className='icon-star'><Icons.Y2kStarIcon /></div>
              {language === 'en' ?
