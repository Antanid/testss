...
export const BonusesBlock = ({ language, Icons, Images }) => {
    ...
    return (
        <section className={`${styles.b1} ${styles.bonuses}`}>
          <div className={styles.bonuses_bg_stars_pattern}><Images.BgStars/></div>
          <div
          ...
          >
            ...
            <div className={styles.bonuses_container_c1_particle}>
              <img className={styles.bonuses_container_c1_particle_i1} src="bonuses_particle_1.svg" alt="" />
              <img className={styles.bonuses_container_c1_particle_i2} src="bonuses_particle_2.svg" alt="" />
            </div>
                ...
                >
                  <div className={styles.bonuses_container_c2_item_content}>
                    ...
                    <div className={styles.bonuses_container_c2_item_content_bottom}>
                      <div className={styles.bonuses_container_c2_item_content_bottom_icon}><Icons.StarIcon/></div>
