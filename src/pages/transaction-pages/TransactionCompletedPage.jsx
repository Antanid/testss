...
import { BtnConnectManager, BtnGoToExchanger, BtnGoToTransaction } from '../exchanger-page/components/Buttons';
...
export const TransactionCompletedPage = () => {
    ...
    eth: {
      ...
      icon :(
        <svg viewBox="0 0 62 61" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M30.7132 0C36.7863 0 42.7231 1.78879 47.7727 5.14018C52.8224 8.49156 56.7581 13.255 59.0822 18.8281C61.4062 24.4013 62.0143 30.5338 60.8295 36.4502C59.6447 42.3667 56.7202 47.8013 52.4259 52.0667C48.1315 56.3322 42.6602 59.2371 36.7037 60.4139C30.7473 61.5908 24.5732 60.9868 18.9624 58.6783C13.3515 56.3698 8.55585 52.4606 5.18179 47.4449C1.80773 42.4292 0.00683594 36.5323 0.00683594 30.5C0.00683594 22.4109 3.24196 14.6531 9.00052 8.93324C14.7591 3.21338 22.5694 0 30.7132 0Z" fill="white"/>
          <path d="M30.7132 6.54918L46.8703 30.5305L30.7132 38.6158L14.5561 30.5L22.6346 18.5079L30.7132 6.54918ZM30.7132 41.846L15.4521 33.7579L30.7132 54.4508L45.9742 33.7579L30.7132 41.846Z" fill="#343434" />
          <path d="M30.7132 6.54918L38.7917 18.5079L46.8703 30.5L30.7132 24.4416V6.54918Z" fill="#343434" />
          ...
          <path d="M30.7132 6.54918L22.6346 18.5079L14.5561 30.5L30.7132 24.4416V6.54918Z" fill="#8C8C8C"/>
        ...
        </svg>), // Тестовый вариант (далее выгружать из API)
      min: 0.5,
      max: 100000
    },
  ...
  if (!data) {
    return <h1>Ошибка: данные не найдены Ошибка: данные не найдены Ошибка: данные не найдены Ошибка: данные не найдены Ошибка: данные не найдены Ошибка: данные не найдены</h1>;
  }
                ...
                <div className='transaction__direction'>
                  <div className='icon__container'>
                    <svg className='icon' viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M2 20L20 2M20 2H6.5M20 2V15.5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                </div>
              </div>
              ...
              <div className='transaction__center__info__content'>
                <h4 className='text text_h4'>
                  <label className='text_label'>
                    {language === 'en' ?
                      'Quantity:' :
                      `Количество:`}
                  </label> {coinsData[coinsSend]} {coinsSend} {coinsData[sendCurrency].id}
                </h4>
                <h4 className='text text_h4 text_accent'>
                  ...
                  {language === 'en' ?
                      'Chain:' :
                      `Сеть:`}
                  </label> {coinsData[sendCurrency].chain}
                </h4>
              </div>
            </div>
          ...
          <div className='transaction__timer transaction__container container_accent'>
              ...
              <div className='final__icon'>
                {(() => {
                  switch (status) {
                    case 'cancel':
                      return (
                      <svg className='icon' viewBox="0 0 213 213" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M45.7361 45.7361L167.264 167.264M106.5 194C58.1751 194 19 154.825 19 106.5C19 58.1751 58.1751 19 106.5 19C154.825 19 194 58.1751 194 106.5C194 154.825 154.825 194 106.5 194Z"
                        stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
                        <path opacity="0.05" d="M42.9583 42.9583L170.042 170.042M106.5 198C55.9659 198 15 157.034 15 106.5C15 55.9659 55.9659 15 106.5 15C157.034 15 198 55.9659 198 106.5C198 157.034 157.034 198 106.5 198Z"
                        stroke="white"
                        strokeWidth="29" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      );
                    case 'contact_manager':
                      return (
                        <svg viewBox="0 0 209 209" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M76.7575 76.049C78.418 70.9323 81.4598 66.3788 85.5493 62.8839C89.6387 59.389 94.6202 57.0923 99.9332 56.2494C105.246 55.4064 110.685 56.0483 115.656 58.1058C120.626 60.1633 124.931 63.5573 128.093 67.9087C131.256 72.2602 133.15 77.3999 133.573 82.7627C133.996 88.1255 132.926 93.5021 130.484 98.2954C128.043 103.089 124.327 107.11 119.741 109.921C115.154 112.732 109.879 114.22 104.5 114.22V123.947M104.5 192C56.1751 192 17 152.825 17 104.5C17 56.1751 56.1751 17 104.5 17C152.825 17 192 56.1751 192 104.5C192 152.825 152.825 192 104.5 192ZM104.984 153.111V154.083L104.016 154.085V153.111H104.984Z"
                          stroke="white" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round"/>
                          <path opacity="0.05" d="M75.4893 74.7484C77.2257 69.3978 80.4065 64.6361 84.6829 60.9814C88.9594 57.3267 94.1686 54.9251 99.7244 54.0436C105.28 53.1621 110.968 53.8334 116.166 55.9849C121.363 58.1365 125.865 61.6856 129.172 66.236C132.479 70.7864 134.46 76.161 134.902 81.769C135.344 87.3769 134.226 92.9994 131.672 98.0118C129.119 103.024 125.234 107.23 120.437 110.169C115.641 113.109 110.125 114.664 104.5 114.664V124.836M104.5 196C53.9659 196 13 155.034 13 104.5C13 53.9659 53.9659 13 104.5 13C155.034 13 196 53.9659 196 104.5C196 155.034 155.034 196 104.5 196ZM105.006 155.333V156.35L103.994 156.352V155.333H105.006Z"
                          stroke="white" stroke-width="25" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        );
                    case 'success':
                      return (
                        <svg viewBox="0 0 211 211" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M134.667 86.0556L95.7778 124.944L76.3333 105.5M105.5 193C57.1751 193 18 153.825 18 105.5C18 57.1751 57.1751 18 105.5 18C153.825 18 193 57.1751 193 105.5C193 153.825 153.825 193 105.5 193Z"
                          stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
                          <path opacity="0.03" d="M135.667 85.3889L95.4444 125.611L75.3333 105.5M105.5 196C55.5182 196 15 155.482 15 105.5C15 55.5182 55.5182 15 105.5 15C155.482 15 196 55.5182 196 105.5C196 155.482 155.482 196 105.5 196Z"
                          stroke="white" strokeWidth="29" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        );
                    default:
                      return '';
            ...
            <div className='transaction__timer__bottom'>
              ...
              <h4 className='text text_h4 text_h4_dark-gray text_copy' onClick={handlerCopyID}>
                ...
                <svg className='copy-icon' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
